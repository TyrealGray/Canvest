...
// Prefer the local installation of @canvest/canvest-dev-server
// if (importLocal('@canvest/canvest-dev-server')) {
// 	debug('Using local install of @canvest/canvest-dev-server');
//
// 	return;
// }
...
// eslint-disable-next-line import/no-extraneous-dependencies
// eslint-disable-next-line import/no-dynamic-require
const config = require(convertArgvPath)(yargs, {...argv, config: './node_modules/@canvest/canvest-dev-server/canvest.config.js'}, {
